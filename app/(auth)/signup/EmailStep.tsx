      ...
      <div className="w-full">
        ...
        <button
          ...
          className={clsx(
            ...
            {
              'bg-orange border-darkorange-border cursor-pointer hover:bg-orange-button-hover': isValidEmail(),
              'bg-orange border-darkorange-border cursor-not-allowed': !isValidEmail(),
            }
          )}
